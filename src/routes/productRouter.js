...
// Variant routes
router.route("/:id/variants").post(productController_1.addNewVariant);
router.route("/:id/variants/:variantId").patch(productController_1.updateVariant).delete(productController_1.deleteVariant);
