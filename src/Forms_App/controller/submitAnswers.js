...
exports.submitFormAnswers = void 0;
const formBlueprint_1 = require("../models/formBlueprint");
const submitFormAnswers = async (req, res, next) => {
    try {
        ...
        // * Find the form by ID
        const form = await formBlueprint_1.FormBlueprintModel.findById(formId);
        if (!form) {
            res.status(404).json({
                success: false,
...
exports.submitFormAnswers = submitFormAnswers;
