...
// ~ ############### CreateEntitiy
const createEntitiy = (Model, ModelName) => (0, catchErrors_1.catchError)(async (req, res, next) => {
...
// ~ ############### CreateEntitiy
// ~ ############### GetEntitiy
const getEntitiy = (Model) => (0, catchErrors_1.catchError)(async (req, res, next) => {
    const { id } = req.params;
...
// ~ ############### GetEntitiy
// ~ ############### GetAllEntitiy
const getAllEntitiy = (Model) => (0, catchErrors_1.catchError)(async (req, res, next) => {
    const docs = await new APIFeatuers_1.default(Model.find(), req.query).paginate().filter().sort().limitFields().query;
...
// ~ ############### GetAllEntitiy
// ~ ############### UpdateEntitiy
const updateEntitiy = (Model) => (0, catchErrors_1.catchError)(async (req, res, next) => {
    const { id } = req.params;
...
// ~ ############### UpdateEntitiy
// ~ ############### DeleteEntitiy
const deleteEntitiy = (Model) => (0, catchErrors_1.catchError)(async (req, res, next) => {
    const { id } = req.params;
